...
class TestingProcessManager {
    ...
    public static abstract class TestingProcess extends Thread {
        ...
        io.supertokens.storage.sqlite.ProcessState.EventAndException checkOrWaitForEventInPlugin(
                io.supertokens.storage.sqlite.ProcessState.PROCESS_STATE state)
                throws InterruptedException {
        ...
        io.supertokens.storage.sqlite.ProcessState.EventAndException checkOrWaitForEventInPlugin(
            ...
            io.supertokens.storage.sqlite.ProcessState.EventAndException e =
                    io.supertokens.storage.sqlite.ProcessState
                            .getInstance(start)
            ...
            if (e == null) {
                ...
                while (e == null && (System.currentTimeMillis() - startTime) < timeToWaitMS) {
                    Thread.sleep(100);
                    e = io.supertokens.storage.sqlite.ProcessState.getInstance(start).getLastEventByName(state);
                }
            }
            return e;
        }
